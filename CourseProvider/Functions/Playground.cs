...
public class Playground(ILogger<Playground> logger)
{
    ...
    public async Task<HttpResponseData> Run([HttpTrigger(AuthorizationLevel.Function, "get", Route = "graphql")] HttpRequestData req)
    {
        ...
        response.Headers.Add("Content-Tpye", "text/html; charset-utf-8"); 
    ...
    private string PlaygroundPage()
    {
        return @"
            ...
            <html>
            <head>
                <title> HotChoclate Playground </title>
                <link> rel ="" stylesheet"" href=""https://cdn.jsdelivr.net/npm/graphql-playground-react/build/static/css/index.css""/>
                <link> rel ="" stylesheet"" href=""https://cdn.jsdelivr.net/npm/graphql-playground-react/build/favicon.png""/>
                <script> rel ="" stylesheet"" href=""https://cdn.jsdelivr.net/npm/graphql-playground-react/build/static/js/middleware.js""/script>
            </head>
         <body>
            <div id=""root""> </div>
            <script>
